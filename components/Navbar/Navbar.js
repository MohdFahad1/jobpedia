...
const Navbar = () => {
  ...
  return (
    <nav className="flex lg:justify-around lg:px-[0] items-center text-lg font-semibold justify-between px-5 bg-transparent h-[80px] shadow-sm z-10">
      <Link href="/">
        <Image src={logo} alt="logo" className=" bg-transparent h-[60px] w-[70px] mt-2" />
      </Link>
      <ul className={`lg:static lg:flex lg:flex-row lg:gap-0 lg:justify-around lg:w-[600px] ${isOpen ? "block" : "hidden"} w-auto top-20 right-4 p-3 flex flex-col gap-6 absolute bg-white lg:shadow-none shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] z-20`}>
