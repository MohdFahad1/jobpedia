...
const Hero = () => {
    return (
        <section className="flex justify-between items-center px-0 mt-10 mb-10 md:justify-center lg:mt-0 lg:px-20 lg:justify-normal">
            <div className="text-center md:flex md:flex-col md:items-center lg:text-left lg:justify-normal lg:items-start">
                ...
                <p className="my-4 text-lg text-gray-500 w-auto md:w-[570px] lg:w-[570px]">
